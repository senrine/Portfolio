...
var RadioRoot = React2.forwardRef(
  ({
    as,
    value,
    defaultValue,
...
var RadioItem = React2.forwardRef(
...
var RadioIndicator = React2.forwardRef(({ as, className, children, ...props }, ref) => {
  const Element = as || "span";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.radioIndicator ?? radioIndicatorTheme;
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...props, className: styles, ref, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      width: "9px",
      height: "9px",
