...
var TimelineRoot = React2.forwardRef(
  ({
    as,
    value,
    defaultValue,
...
var TimelineHeader = React2.forwardRef(({ as, className, children, ...props }, ref) => {
  const Element = as || "div";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.timelineHeader ?? timelineHeaderTheme;
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...props, ref, className: styles, children });
});
TimelineHeader.displayName = "MaterialTailwind.TimelineHeader";
var TimelineIcon = React2.forwardRef(
...
var TimelineSeparator = React2.forwardRef(({ as, className, children, ...props }, ref) => {
  const Element = as || "div";
  const contextTheme = useTheme();
...
var TimelineBody = React2.forwardRef(
  ({ as, className, children, ...props }, ref) => {
    const Element = as || "div";
    const contextTheme = useTheme();
