...
var BreadcrumbRoot = React2.forwardRef(
...
var BreadcrumbLink = React2.forwardRef(({ as, className, children, ...rest }, ref) => {
  const Element = as || "a";
  const contextTheme = useTheme();
...
var BreadcrumbSeparator = React2.forwardRef(({ as, className, children, ...rest }, ref) => {
  const Element = as || "span";
  const contextTheme = useTheme();
  const theme2 = contextTheme.breadcrumbSeparator || breadcrumbSeparatorTheme;
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...rest, ref, className: styles, children: children || "/" });
});
