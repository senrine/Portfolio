...
var ChipRoot = React2.forwardRef(
  ({
    as,
    size,
    color,
    ...
    return open ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...rest, ref, "data-open": open, className: styles, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChipContext.Provider, { value: contextValue, children }) }) : null;
  }
);
ChipRoot.displayName = "MaterialTailwind.Chip";
var ChipLabel = React2.forwardRef(
...
var ChipIcon = React2.forwardRef(
  ({ as, className, children, ...rest }, ref) => {
    const Element = as ?? "span";
    const contextTheme = useTheme();
    const { size } = React2.useContext(ChipContext);
...
var ChipDismissTrigger = React2.forwardRef(({ as, ripple, className, children, ...rest }, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...rest, ref, className: styles, onClick: handleClick, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      viewBox: "0 0 24 24",
      fill: "none",
