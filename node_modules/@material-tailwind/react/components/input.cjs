...
var InputRoot = React2.forwardRef(
  ({
    as,
    color,
    size,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...props, ref, className: styles, "aria-disabled": disabled, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InputContext.Provider, { value: contextValue, children }) });
  }
);
InputRoot.displayName = "MaterialTailwind.Input";
var InputField = React2.forwardRef(
  ({ type = "text", ...rest }, ref) => {
    const contextTheme = useTheme();
    const {
      size,
...
var InputIcon = React2.forwardRef(
