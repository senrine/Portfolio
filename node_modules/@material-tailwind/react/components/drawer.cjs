...
var DrawerOverlay = React2.forwardRef(({ className, lockScroll, children, ...rest }, ref) => {
  const contextTheme = useTheme();
...
var DrawerPanel = React2.forwardRef(
  ({
    as,
    className,
    children,
...
var DrawerDismissTrigger = React2.forwardRef(({ as, className, children, ...rest }, ref) => {
  const Element = as || "button";
  const contextTheme = useTheme();
