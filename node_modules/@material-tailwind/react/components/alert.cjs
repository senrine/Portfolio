...
var AlertRoot = React2.forwardRef(
  ({
    as,
    color,
    variant,
...
var AlertContent = React2.forwardRef(
...
var AlertIcon = React2.forwardRef(
  ({ as, className, children, ...rest }, ref) => {
...
var AlertDismissTrigger = React2.forwardRef(({ as, ripple, className, children, ...rest }, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...rest, ref, className: styles, onClick: closeAlert, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      viewBox: "0 0 24 24",
      fill: "none",
