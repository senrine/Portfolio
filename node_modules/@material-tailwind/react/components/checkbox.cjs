...
var CheckboxRoot = React2.forwardRef(
...
var CheckboxIndicator = React2.forwardRef(({ as, className, children, ...props }, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Element, { ...props, "data-checked": checked, className: styles, ref, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      fill: "none",
      width: "18px",
